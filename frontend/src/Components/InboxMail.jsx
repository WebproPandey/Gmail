  ...
  return (
    <div className="h-full w-full bg-black/20 ">
      ...
      <div className="mailinbox w-full min-h-full overflow-y-auto    ">
        {emails.map((email) => (
          <div  key={email._id} className="mail w-full h-[8vh] bg-[#F2F6FC] border-[0.4px] border-black/30 flex justify-center  items-center px-[1vw] relative group transition-all duration-300  z-[1] hover:shadow-lg hover:z-[2] hover:border-[1.5px] ">
